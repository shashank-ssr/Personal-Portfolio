...
export default function SectionTitle({ kicker, title, subtitle, accent = "yellow", className = "" }) {
  return (
    <div className={`max-w-3xl min-w-0 ${className}`}>
      <span className={`inline-flex border-4 border-black px-3 py-2 font-display text-xs uppercase tracking-[0.24em] shadow-[2px_2px_0_#000] sm:shadow-[4px_4px_0_#000] ${accentClasses[accent]}`}>
        {kicker}
      </span>
